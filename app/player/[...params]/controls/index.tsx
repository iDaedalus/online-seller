      ...
      <AnimatePresence>
        {open && (
          <>
            ...
            <motion.div
              className="absolute md:right-0 right-1/2 translate-x-1/2 md:translate-x-0 bottom-full lg:mb-3 z-20 lg:w-90 w-3xs bg-neutral-950/80 backdrop-blur-lg rounded-md shadow-xl overflow-hidden"
